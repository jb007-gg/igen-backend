...
export function AboutSection({ 
  ...
  const defaultTitle = "Ra đời từ Thực chiến, Dành cho Chủ Doanh nghiệp.";
  const defaultDescription = "Chúng tôi nhận thấy các chủ doanh nghiệp tâm huyết đang phải làm marketing một cách rời rạc và lãng phí nguồn lực. iGen Technology được sinh ra để thay đổi điều đó, với triết lý công nghệ phải đơn giản, tin cậy và hiệu quả.";
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16">
          <div className={cn(
            ...
            <div className="space-y-4">
             ...
             <div className={cn("flex", isPrimaryBg ? "justify-center" : "justify-start")}>
