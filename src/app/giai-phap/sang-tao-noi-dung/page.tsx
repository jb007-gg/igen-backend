  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section id="content-details" className="w-full py-12 md:py-24 lg:py-32">
        ...
        <section id="cta" className="w-full py-12 md:py-24 lg:py-32 bg-secondary">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl font-headline">
                Biến sản phẩm của bạn thành ngôi sao?
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-muted-foreground md:text-xl">
                Khám phá cách công nghệ "Bản sao số" có thể cách mạng hóa hoạt động marketing của bạn.
            </p>
             <div className="mt-8">
