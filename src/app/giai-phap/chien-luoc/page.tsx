  ...
  return (
    <div className="flex min-h-[100dvh] flex-col bg-background">
      ...
      <main className="flex-1">
        ...
        <section id="strategy-details" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
              <Megaphone className="h-12 w-12 text-primary" />
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl font-headline">
                Lộ trình 4 Giai đoạn Kiến tạo Tăng trưởng
              </h2>
            </div>
        ...
        <section id="cta" className="w-full py-12 md:py-24 lg:py-32 bg-secondary">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl font-headline">
                Sẵn sàng Xây dựng Nền tảng Vững chắc?
            </h2>
            <p className="mx-auto mt-4 max-w-3xl text-muted-foreground md:text-xl">
                Hãy để chúng tôi giúp bạn vẽ ra tấm bản đồ thành công. Liên hệ ngay để được tư vấn miễn phí.
            </p>
             <div className="mt-8">
